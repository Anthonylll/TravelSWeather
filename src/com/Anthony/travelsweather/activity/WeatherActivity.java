...
public class WeatherActivity extends Activity implements OnClickListener{
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		setContentView(R.layout.weather_layout); //注意导入的R包是否为自己工程的包
		//初始化各控件
	...
	public void onClick(View v) {
		...
		case R.id.refresh_weather:
			...
			String weatherCode = prefs.getString("weather_code", "");    //weather_code???
	...
	countyCode + ".xml";
		queryFormatServer(address, "countyCode");
	}
	...
	weatherCode + ".html";
		queryFormatServer(address,"weatherCode");
	}
	
	/*
	 * 根据传入的地址和类型去向服务器查询天气代号或者天气信息。
	 * */
	private void queryFormatServer(final String address, final String type) {
	...
	private void changeBackground(WeatherKind weather) {
		view = (RelativeLayout) findViewById(R.id.weather_background);
		switch (weather) {
		case cloudy:
